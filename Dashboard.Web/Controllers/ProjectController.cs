...
public class ProjectController : Controller
{
    ...
    public async Task<IActionResult> Add([FromBody] Project employee)
    {
        ...
        if (ModelState.IsValid)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var desEmployee = JsonConvert.DeserializeObject<Project>(employeeAsString);
    ...
    [HttpPut]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit([FromBody] Project employee)
    {
